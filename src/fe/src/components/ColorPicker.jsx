...
function CustomPointer() {
    return (
        <div className="w-3 h-3 rounded-full border-[3px] border-[#FFFFFF] bg-transparent drop-shadow-lg" />
    )
}

function CustomPointerLine() {
    return (
        <div className="w-3 h-3 rounded-full border-[3px] border-[#FFFFFF] bg-white drop-shadow-lg -translate-x-1.5" />
    )
}

function CustomHexInput({ initHex, initAlpha, onChange }) {
    ...
    return (
        <div
            className="flex flex-row gap-1.5 items-center w-full bg-[#D3D3D3] dark:bg-[#1F2937] border border-[#636A72] rounded-lg focus:outline-none px-2">
            <input
                type="text"
...
function CustomRGBInput({ initRgb, onChange }) {
    ...
    return (
        <div
            className="flex flex-row gap-1.5 items-center w-full bg-[#D3D3D3] dark:bg-[#1F2937] border-[#636A72] border rounded-lg focus:outline-none px-2">
            <input
                type="text"
...
function ColorPicker({color, onDefault, onCancel, onSave}) {
    ...
    return (
        <div
            className="flex flex-col w-[16rem] bg-[#D3D3D3] dark:bg-[#1F2937] rounded-[0.625rem] drop-shadow-lg justify-center items-center px-1 py-2">
            ...
            <button
                    className="flex-1 text-center whitespace-nowrap text-xs text-white dark:text-[#D1D5DB] bg-[#91969C] dark:bg-inherit rounded-[0.25rem] p-0.5" onClick={onDefault}>
                    Restore Defaults
                </button>
                <button className="flex-1 text-center text-xs text-white dark:text-[#D1D5DB] bg-[#91969C] dark:bg-inherit rounded-[0.25rem] px-4 py-0.5" onClick={onCancel}>
                    Cancel
                </button>
                <button className="flex-1 text-center text-xs text-white dark:text-[#D1D5DB] bg-[#3B82F6] rounded-[0.25rem] px-4 py-0.5" onClick={() => onSave(tempColor.toHexString())}>
                    Save
                </button>
            </div>
        </div>
