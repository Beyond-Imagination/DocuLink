...
const Search = ({ searchWord, setSearchWord, handleSearch, handleSearchReset }) => {
  return (
    <div className="w-[20rem]">
      <form className="max-w-md mx-auto" onSubmit={(e) => e.preventDefault()}>
        ...
        <div className="relative">
          ...
          <div className="absolute items-center end-0 inset-y-0 right-[6rem] flex cursor-pointer" onClick={handleSearchReset}>
          ...
          <button
            type="submit"
            className="text-white w-[5rem] absolute end-2.5 bottom-2.5 bg-[#0C66E4] dark:bg-[#0C66E4]/50 hover:bg-blue-700 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded text-sm px-4 py-2 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
